...
export function PlantCell({ position, plant, onPlantAction, onPlantSeed }: PlantCellProps) {
  ...
  return (
    ...
    >
      ...
      {/* Status Tooltip */}
      <div
        className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-card rounded-lg shadow-lg border border-border p-3 z-20 transition-all duration-200 ease-in-out min-w-[200px] ${showTooltip
